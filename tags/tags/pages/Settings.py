...
#     0, -- Day of the week. Monday =1... Sunday =7. Not Applicable =0
#     0,--day of the month : calendar date of the month. 0- Not Applicable
#     '00:01', -- Time to run HH:MM
#     'sb_dw_db.public.test_stored_procedure',-- Stored proc to run at the schduled time
